 ...
 * Usada quando um usuário deseja emprestar um item, mas ele não está cadastrado no sistema.
 * @author Lara
 */
public class ExceptionItemNaoCadastrado extends Exception{
     ...
     */
    public ExceptionItemNaoCadastrado(String mensagem)
    {
